...
class Organization(Base):
    ...
    privacy_contact_email: Mapped[str | None] = mapped_column(String(254), nullable=True)
    participant_privacy_notice: Mapped[str] = mapped_column(Text, default="")
    privacy_notice_version: Mapped[int] = mapped_column(Integer, default=1)
